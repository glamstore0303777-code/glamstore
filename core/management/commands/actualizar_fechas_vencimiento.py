...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # DESHABILITADO: El campo fecha_vencimiento no existe en la tabla pedidos
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Comando deshabilitado: El campo fecha_vencimiento no existe en la tabla pedidos")
        )
